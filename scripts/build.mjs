...
await Promise.all([
  ...
  copyFile(resolve(projectRoot, "assets", "launcher.icns"), resolve(outputRoot, "launcher.icns")),
  copyFile(resolve(projectRoot, "packaging", "launcher.ps1"), resolve(outputRoot, "launcher.ps1")),
  copyFile(resolve(projectRoot, "packaging", "overlay.ps1"), resolve(outputRoot, "overlay.ps1")),
  copyFile(
    resolve(projectRoot, "packaging", "overlay-core.ps1"),
    resolve(outputRoot, "overlay-core.ps1"),
  ),
  copyFile(resolve(projectRoot, "packaging", "launcher.sh"), resolve(outputRoot, "launcher.sh")),
